...
public class AudioSettingsState extends BasicGameState implements InputListener {
	...
	public void init(GameContainer gc, StateBasedGame game) throws SlickException {
		musicVolumeSlider = new Slider("musicVolume", "Music Volume", new Pair<Float>((Globals.WIDTH / 2) - 150.0f, 300.0f), 300.0f, musicVolumeOperation);
		...
		soundVolumeSlider = new Slider("soundVolume", "Sound FX Volume", new Pair<Float>((Globals.WIDTH / 2) - 150.0f, 400.0f), 300.0f, soundVolumeOperation);
	...
	public void render(GameContainer gc, StateBasedGame game, Graphics g) throws SlickException {
		...
		musicVolumeSlider.render(null, g, 0L);
		soundVolumeSlider.render(null, g, 0L);
