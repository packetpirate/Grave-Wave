...
public class AK47 extends Weapon {
	...
	public AK47() {
		...
		this.fireSound = assets.getSound(AK47.FIRE_SOUND);
	...
	public Image getInventoryIcon() {
		return AssetManager.getManager().getImage(AK47.ICON_NAME);
	}

	@Override
	public int getClipSize() {
		return AK47.CLIP_SIZE;
	}
