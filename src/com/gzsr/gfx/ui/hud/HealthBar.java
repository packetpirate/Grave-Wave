...
public class HealthBar implements Entity {
	private static final Color HEALTH_COLOR = new Color(0xB928CB);
	...
	public void render(Graphics g, long cTime) {
		...
		changeColor(g, (player.getStatusHandler().hasStatus(Status.POISON) ? POISON_COLOR : HEALTH_COLOR), touchingPlayer);
