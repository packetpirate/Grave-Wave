...
public class AchievementController {
	...
	public void init() {
		...
		{ // Kill an enemy with the Lollipop.
			...
			s0.createTransition(1, s1, (metric -> Metrics.has(metric, Metrics.compose(Metrics.LOLLIPOP, Metrics.ENEMY, Metrics.DAMAGE))));
		...
		{ // Kill Aberration with just the Nail Gun.
			...
			s1.createTransition(3, s0, (metric -> (((Metrics.has(metric, Metrics.ABERRATION) && Metrics.has(metric, Metrics.compose(Metrics.ENEMY, Metrics.DAMAGE)) && !Metrics.has(metric, Metrics.NAIL_GUN))))));
